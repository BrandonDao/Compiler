...
//         [GeneratedRegex(@"^(_?[a-zA-Z_][a-zA-Z0-9_]*)\s*:")]
...
//                 {
//                     grammar.EntryPointName = lineSpan["ENTRYPOINT:".Length..].Trim().ToString();
//                     entryPointSet = true;
//                     continue;
//                 }
...
//                     if (semiIdx >= 0)
//                     {
//                         string beforeSemi = altLine[..semiIdx];
...
//             return tokens;
//         }
//         private static void ComputeFirstSets(Grammar grammar)
//         {
//             // Initialize FIRST sets
//             foreach (var rule in grammar.Rules.Values)
//             {
//                 grammar.FirstSets[rule.Name] = [];
//             }
...
//                 foreach (var rule in grammar.Rules.Values)
//                 {
//                     var first = grammar.FirstSets[rule.Name];
...
//                             {
//                                 // Nonterminal: add its FIRST set (except "empty")
//                                 foreach (var f in grammar.FirstSets[symbol])
//                                 {
//                                     if (f != "EMPTY" && first.Add(f))
//                                         changed = true;
//                                 }
//                                 // If symbol's FIRST set contains "empty", continue to next symbol
//                                 if (!grammar.FirstSets[symbol].Contains("EMPTY"))
//                                     break;
//                                 // If last symbol and all can be empty, add "empty"
//                                 if (i == alt.Count - 1 && first.Add("EMPTY"))
//                                     changed = true;
//                             }
